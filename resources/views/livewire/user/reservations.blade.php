<div class="container py-4">
    @include('components.public.breadcrumbs', [
        'items' => [['label' => 'Dashboard', 'url' => route('user.dashboard')], ['label' => 'Reservasi Saya']],
    ])
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex gap-2">
                    ...
                    <input type="search" class="form-control" placeholder="Cari status/catatan..."
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-outline-primary"
                                        href="{{ route('user.reservations.show', ['reservation' => $r->id]) }}">Lihat</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">Belum ada reservasi.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
