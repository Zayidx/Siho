                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">Rp{{ number_format($monthlyRevenue, 0, ',', '.') }}
                                    </h6>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img
                                                                src="{{ $guest->foto_url ?: 'https://placehold.co/100x100/6c757d/white?text=' . strtoupper(substr($guest->full_name, 0, 1)) }}">
                                                        </div>
                    ...
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl">
                                <img src="{{ \Illuminate\Support\Facades\Auth::user()->foto_url ?: 'https://placehold.co/100x100/6c757d/white?text=' . strtoupper(substr(\Illuminate\Support\Facades\Auth::user()->username, 0, 1)) }}"
                                    alt="Foto Profil">
                            </div>
                            <div class="ms-3 name">
                                <h5 class="font-bold">{{ \Illuminate\Support\Facades\Auth::user()->username }}</h5>
                                <h6 class="text-muted mb-0">
                                    {{ optional(\Illuminate\Support\Facades\Auth::user()->role)->name ?? 'No Role' }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
