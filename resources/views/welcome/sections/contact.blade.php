    ...
    <div class="container px-4 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-5">
            ...
            <div class="col-span-2 p-8 text-white bg-blue-900 rounded-lg md:p-12">
                ...
                <p class="mt-2 text-blue-100">Silakan hubungi kami melalui kontak berikut untuk pertanyaan, reservasi,
                    atau kerja sama.</p>
            ...
            <div class="col-span-3 p-8 bg-white rounded-lg dark:bg-gray-800 md:p-12">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Punya pertanyaan? Isi formulir di bawah dan tim kami
                    akan segera merespons Anda.</p>
                <div class="mt-8">
