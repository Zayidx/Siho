...
<section id="fasilitas" class="py-20 bg-gray-100 dark:bg-gray-900 fade-in-section">
    <div class="container px-4 mx-auto">
        <div class="mb-12 text-center">
            ...
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">Lengkapi pengalaman menginap Anda dengan fasilitas
                terbaik.</p>
        </div>
                        ...
                        @foreach ($facilities ?? collect() as $facility)
                            <li class="flex items-start space-x-4">
                                <div>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">Tersedia untuk meningkatkan kenyamanan
                                        Anda.</p>
                                </div>
                            </li>
                        @endforeach
                    @else
                        <li class="flex items-start space-x-4"><i class="text-3xl text-blue-600 bi bi-heart-pulse"></i>
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white">Spa & Wellness</h3>
                                <p class="text-gray-600 dark:text-gray-400">Layanan pijat aromaterapi, sauna, dan
                                    perawatan tubuh lainnya.</p>
                            </div>
                        </li>
                    @endif
                </ul>
